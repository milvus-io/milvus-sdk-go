...
func (c *Column{{.TypeName}}) Nullable() bool {
	return c.nullable
}
...
func (c *Column{{.TypeName}}) Slice(start, end int) Column {
	l := c.Len()
	if start > l {
		start = l
	}
...
func (c *Column{{.TypeName}}) ValidData() []bool {
...
// NewNullableColumn{{.TypeName}} auto generated constructor
func NewNullableColumn{{.TypeName}}(name string, values []{{.TypeDef}}, validValues []bool) *Column{{.TypeName}} {
	return &Column{{.TypeName}} {
		name: name,
		values: values,
		nullable:    true,
...
func NewAllNullColumn{{.TypeName}}(name string, rowSize int) *Column{{.TypeName}} {
	return &Column{{.TypeName}} {
		name: name,
