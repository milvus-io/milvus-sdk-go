		...
		Indexes: []idxDef{
			...
			// IVF_FLAT
			{
				...
				SearchParams: []idxParam{
					{
						Name:           "nprobe",
						ValidationRule: "", // [1, nilist], refer to index construct param, not supported yet
					},
				},
				ValidExamples: []string{
					"nlist = 10",
			...
			// HNSW
			{
				...
				SearchParams: []idxParam{
					{
						Name:           "ef",
						ValidationRule: "", // [topK, 32768], refer to index construct param, not supported yet
					},
				},
				ValidExamples: []string{
				...
				SearchParams: []idxParam{
					{
						...
						ValidationRule: "[-1, 200]", // -1 or [topk, n * n_trees]
					},
					{
						Name:           "epsilon",
						Type:           "float64",
