...
// CreateIndexV2 create index for collection
func (c *GrpcClient) CreateIndexV2(ctx context.Context, async bool, idx entity.Index, opts ...CreateIndexRequestOption) error {
	if c.Service == nil {
...
// DescribeIndexV2 describe index
func (c *GrpcClient) DescribeIndexV2(ctx context.Context, opts ...DescribeIndexRequestOption) ([]*server.IndexDescription, error) {
	if c.Service == nil {
		return []*server.IndexDescription{}, ErrClientNotReady
	}
...
// DropIndexV2 drop index from collection
func (c *GrpcClient) DropIndexV2(ctx context.Context, opts ...DropIndexOption) error {
	if c.Service == nil {
		return ErrClientNotReady
	}
