...
func createDefaultCollection(ctx context.Context, t *testing.T, mc *base.MilvusClient, autoID bool, opts ...client.CreateCollectionOption) string {
	t.Helper()
...
func createCollectionWithDataIndex(ctx context.Context, t *testing.T, mc *base.MilvusClient, autoID bool, withIndex bool, opts ...client.CreateCollectionOption) (string, entity.Column) {
	// collection
	collName := createDefaultCollection(ctx, t, mc, autoID, opts...)
