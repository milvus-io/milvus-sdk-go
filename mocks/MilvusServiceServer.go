...
type mockConstructorTestingTNewMilvusServiceServer interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewMilvusServiceServer(t mockConstructorTestingTNewMilvusServiceServer) *MilvusServiceServer {
